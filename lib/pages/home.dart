      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Flexible( // ADDED: prevents overflow
              child: Text(
                data["Name"] ?? "",
                style: AppWidget.semiBoldTextFieldStyle(),
                  ...
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(
                        builder: (context) => ProductDetail(
                          ...
                          image: img,   // CHANGED: use img parameter
                          name: name,   // CHANGED: use name parameter
                          price: price.toString(), // CHANGED: use price parameter
                        )));
                  },
